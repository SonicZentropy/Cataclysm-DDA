                                   ...
                                   int days_since_cataclysm )
{
    ...
    bash_vars.num_attempts = 125; // Roughly half as many attempts as old version, may need tweaking
       ...
       if( terrain_type == oter_lab || terrain_type == oter_lab_stairs
        ...
        { // We're below ground, and no sewers
            ...
            tw = (is_ot_match("lab", dat.north(), ot_match_type::contains) &&
                  !is_ot_match("lab_subway", dat.north(), ot_match_type::contains))
                     ? 0
                     : 2;
            rw = (is_ot_match("lab", dat.east(), ot_match_type::contains) &&
                  !is_ot_match("lab_subway", dat.east(), ot_match_type::contains))
                     ? 1
                     : 2;
            bw = (is_ot_match("lab", dat.south(), ot_match_type::contains) &&
                  !is_ot_match("lab_subway", dat.south(), ot_match_type::contains))
                     ? 1
                     : 2;
            lw = (is_ot_match("lab", dat.west(), ot_match_type::contains) &&
                  !is_ot_match("lab_subway", dat.west(), ot_match_type::contains))
                     ? 0
                     : 2;
        ...
        if (one_in(10))
        {
            ...
            case 5:
            {
                ...
                draw_rough_circle([this](const point_bub_ms &p)
                        ...
                        make_rubble( {p, abs_sub.z() } );
                        ter_set( p, ter_t_thconc_floor ); }, center->xy(), 4);
        ...
        { // then no json maps for lab_finale_1level were found
            ...
            case 2:
                ...
                { // 4% of the lab ends will be this weapons testing end.
                    ...
                    line(this, ter_t_reinforced_glass, point_bub_ms(SEEX - 3, SEEY - 2), point_bub_ms(SEEX - 3, SEEY + 1),
                         dat.zlevel());
                    line(this, ter_t_reinforced_glass, point_bub_ms(SEEX + 2, SEEY - 2), point_bub_ms(SEEX + 2, SEEY + 1),
                         dat.zlevel());
                ...
                while (item_count < 5)
                {
                    item_count +=
                        place_items(
                            ...
                            point_bub_ms(SEEX, SEEY), abs_sub.z(), false, calendar::start_of_cataclysm)
                            .size();
                }
                line(this, ter_t_reinforced_glass, point_bub_ms(SEEX - 2, SEEY - 2), point_bub_ms(SEEX + 1, SEEY - 2),
                     dat.zlevel());
                line(this, ter_t_reinforced_glass, point_bub_ms(SEEX - 2, SEEY + 1), point_bub_ms(SEEX + 1, SEEY + 1),
                     dat.zlevel());
                line(this, ter_t_reinforced_glass, point_bub_ms(SEEX - 2, SEEY - 1), point_bub_ms(SEEX - 2, SEEY),
                     dat.zlevel());
                line(this, ter_t_reinforced_glass, point_bub_ms(SEEX + 1, SEEY - 1), point_bub_ms(SEEX + 1, SEEY),
                     dat.zlevel());
