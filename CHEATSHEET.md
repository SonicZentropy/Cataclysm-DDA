...
In src/map.cpp, wrap your container visibility logic with a world-option check, using get_option<bool>( "SHOW_ALL_ITEMS" )
...
```
if( get_option<bool>( "SHOW_ALL_ITEMS" ) && container ) {  
